...
import { CloudSyncIndicator } from "@/components/app-shell/cloud-sync-indicator"
    ...
    return (
        <div className="flex flex-col h-full max-w-2xl mx-auto w-full p-4 space-y-6 pb-24">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <DailySpendingChart dailyTrend={dailyTrend} categories={categories ?? []} defaultCurrency={defaultCurrency} />
            </div>
